  ...
  public testPost(done) {
    this.chai.request(this.server)
      ...
      .end((err, res) => {
        ...
        res.body.should.have.a.property('message');
        res.body.message.should.to.be.an('array').that.to.deep.equal([{ id: 0, name: 'World' }]);
        done();
      });
  }
  ...
  public testGetById(done) {
    this.chai.request(this.server)
      ...
      .end((err, res) => {
        ...
        res.body.method.should.be.equal('GET');
        res.body.should.have.a.property('message');
        res.body.message.should.to.be.an('object').that.to.deep.equal({ id: 0, name: 'World' });
        done();
      });
  }
  ...
  public testPut(done) {
    this.chai.request(this.server)
      ...
      .end((err, res) => {
        ...
        res.body.should.have.a.property('message');
        res.body.message.should.to.be.an('array').that.to.deep.equal([{ id: 0, name: 'Ocean' }]);
        done();
      });
  }
